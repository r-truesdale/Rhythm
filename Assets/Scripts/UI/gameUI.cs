...
public class gameUI : MonoBehaviour
{
    ...
    [SerializeField] private Button BeatObjectVisibilityBtn;
    [SerializeField] private Button BeatObjectVisibilityOnBtn;
    ...
    public void endBtn()
    {
        ...
        endBtnPressed = true;
        SpawnManager.Instance.stopSpawn();
        SpawnManager.Instance.destroyBeatObjects();
    ...
    public void BeatObjectVisibility()
    {
        SpawnManager.Instance.setBeatObjectVisibility();
    }
    public void BeatObjectVisibilityOn()
    {
        SpawnManager.Instance.setBeatObjectVisibility();
    }
}
